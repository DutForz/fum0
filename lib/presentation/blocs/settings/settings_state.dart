...
class SettingsLoaded extends SettingsState { const SettingsLoaded({required this.isDarkMode}); final bool isDarkMode; @override List<Object?> get props => [isDarkMode]; }
